    ...
    <div class="form-container">
      <form id="signup" @submit="${this.handleForm}">
        <div class="header">
          ...
          ${
            this.signed ? html`<p class="signed">Merci pour votre inscription</p>` : html``
          }
        </div>
        <div class="sep"></div>
        <div class="inputs">
          <input placeholder="Username" type="text" .value="${this.username}" @input="${e => this.username = e.target.value}">
          <input placeholder="Email" type="email" .value="${this.email}" @input="${e => this.email = e.target.value}">
